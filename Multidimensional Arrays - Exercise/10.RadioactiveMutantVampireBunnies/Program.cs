namespace _10.RadioactiveMutantVampireBunnies
{
    ...
    {
        private static readonly int[] rowDirections = new[] { -1, 0, 1, 0 };
        private static readonly int[] colDirections = new[] { 0, 1, 0, -1 };
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (!playerMovement.ContainsKey(commands[i]))
                {
                    continue;
                }
                ...
                if (!SpreadBunnies(matrix, bunnies))
                {
                    isDead = true;
                }
            }
        ...
        private static bool SpreadBunnies(char[,] matrix, Queue<int[]> bunnies)
        {
            ...
            for (int i = 0; i < bunniesCount; i++)
            {
                ...
                {
                    int nextRow = bunnyPos[0] + rowDirections[j];
                    int nextCol = bunnyPos[1] + colDirections[j];
